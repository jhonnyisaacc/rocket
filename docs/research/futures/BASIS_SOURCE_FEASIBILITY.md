...
**Pre-result correction for FUT-004:** the table above used the original FUT-001 futures tape. The [FUT-004 data amendment](experiments/FUT-004-DATA.md) applies the same eligibility rule to the previously checksum-repaired FUT-002 tape, restoring 2,557 missing active-bar symbol-days in 2022. Its 2022 count is 29,182; 2023–2025 counts are unchanged. Preserve both hashes and use the amended version for FUT-004 outcomes.
